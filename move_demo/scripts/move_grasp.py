...
class MoveRobot():
    def __init__(self):
        ...
        # move service
        self.navigate_to_point = rospy.ServiceProxy('navigate_to_point', NavigateToPoint)
    ...
    def move_base_to_goal(self, x, y, theta):
        ...
        try:
            resp = self.navigate_to_point(x, y, theta)
            return resp.result
    ...
    # Move the base to another location after grasping the object
        self.move_base_to_goal(0.0, 0.5, 0.0)  # example coordinates
